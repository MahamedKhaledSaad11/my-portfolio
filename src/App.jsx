...
const experienceData = [
  {
    ...
    description:["Introduction to Artificial intelligence and its Applications, Python Programming",
...

  {
    ...
    date: "Jube 2025",
    description:["Completed an 80-hour Artificial Intelligence course by Huawei Academy, covering Python programming,\
      mathematics for AI,data analysis, machine learning, and deep learning",
...

  {
    ...
    description:["Introduced to major ideas, methods, and techniques of computer vision and pattern recognition.",
  ...
  
  {
    ...
    description:["Intensive training in Data Science foundations, including data analysis, visualization, SQL databases,\
      and Python-based workflows for extracting insights and building data-driven solutions.",
      "Hands-on experience in Machine Learning and applied AI, covering model development, evaluation,\
      and deployment-oriented practices using industry tools such as MLflow and Hugging Face.",
      "Completion of end-to-end projects and a capstone, applying the full data science lifecycle—from problem formulation\
      and data preparation to model building and real-world business insight generation.",
    ]
  }
];
...
const skills = {
  technical: [
    { name: "Python (AI & ML)", icon: <Brain size={18} /> },
    { name: "C++", icon: <Cpu size={18} /> },
    { name: "Java", icon: <Code2 size={18} /> },
    { name: "SQL & Databases", icon: <Database size={18} /> },
    { name: "Deep Learning", icon: <Layers size={18} /> },
    { name: "Git & GitHub", icon: <GitGraph size={18} /> },
  ],
  soft: [
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12">
          ...
          <div className="w-full md:w-1/2 flex justify-center md:justify-end relative">
            <div className="relative w-64 h-64 md:w-80 md:h-80">
              {/* Added a subtle Pulse animation effect to the background glow */}
          ...
          {experienceData.map((item, index) => (
            <div key={index} className="bg-slate-900 rounded-xl shadow-md p-6 md:p-8 flex flex-col md:flex-row gap-6 border-l-4 border-blue-500 hover:bg-slate-800 transition-colors duration-300">
              ...
              <div className="flex-grow text-center md:text-left">
                ...
                {/* Description Logic: Handles Lists or Single Text */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div>
            <div className="flex items-center mb-8">
              <div className="p-3 rounded-lg bg-slate-800 text-blue-400 mr-4 border border-slate-700">
                <Cpu size={24} />
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {skills.technical.map((skill, index) => (
                <div key={index} className="flex items-center p-4 bg-slate-800 rounded-lg border border-slate-700 hover:border-blue-500/50 hover:shadow-md hover:shadow-blue-500/10 transition-all group">
                  <span className="text-slate-400 group-hover:text-blue-400 transition-colors mr-3">{skill.icon}</span>
          ...
          <div>
            <div className="flex items-center mb-8">
              <div className="p-3 rounded-lg bg-slate-800 text-green-400 mr-4 border border-slate-700">
                <Users size={24} />
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {skills.soft.map((skill, index) => (
                <div key={index} className="flex items-center p-4 bg-slate-800 rounded-lg border border-slate-700 hover:border-green-500/50 hover:shadow-md hover:shadow-green-500/10 transition-all group">
                  <span className="text-slate-400 group-hover:text-green-400 transition-colors mr-3">{skill.icon}</span>
                  <span className="font-medium text-slate-200">{skill.name}</span>
                </div>
              ))}
            </div>
